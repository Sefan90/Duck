...
function love.load()
    ...
    player = {
        name = 'player',
        up = {
            x = math.floor((width/2)/mapsize)*mapsize-mapsize*0.5,
            y = math.floor((height/2)/mapsize)*mapsize-mapsize*0.5,
            w = mapsize,
            h = mapsize/10},
        down = {      
            x = math.floor((width/2)/mapsize)*mapsize-mapsize*0.5,
            y = math.floor((height/2)/mapsize)*mapsize+1.40*mapsize,
            w = mapsize,
            h = mapsize/10},
        right = {      
            x = math.floor((width/2)/mapsize)*mapsize+mapsize*0.75,
        ...
        current = {
            x = math.floor((width/2)/mapsize)*mapsize-mapsize*0.5,
            y = math.floor((height/2)/mapsize)*mapsize-mapsize*05,
            w = mapsize,
            h = mapsize/10},
        lastkey = nil,
        speed = 0.2
...
function love.draw()
    ...
    love.graphics.circle('line', life.x+mapsize, life.y+mapsize, mapsize*1.1, 6)
    love.graphics.setColor(0,0,0)
    love.graphics.rectangle('line', life.x,life.y,life.w,life.h)
